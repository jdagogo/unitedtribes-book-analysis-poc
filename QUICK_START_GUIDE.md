...
| 208 | "emotional experience" | HBO Max documentary |
...
1. **Discovery passages** = Highlight the exact text to trigger modals
2. **Purple/pink cards** = Article previews with screenshots
...
6. **Yellow highlighting** = Planned feature (not yet implemented)
...
- **Version Control Interface**: `file:///Users/j.d.heilprin/Desktop/my-claude/united-tribes-fresh/version-control.html`
  - Access the comprehensive project dashboard with all documentation in one place
  - Interactive navigation with keyboard shortcuts (keys 1-8)
  - Includes project overview, features, architecture, and development guides
