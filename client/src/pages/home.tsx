            ...
            <CardContent className="py-8">
              ...
              <div className="flex justify-center mb-6">
                <div className="inline-flex rounded-lg border-2 border-amber-300 p-1.5 bg-white">
                  ...
                  <Button
                    onClick={() => setActiveHub("bluenote")}
                    variant={activeHub === "bluenote" ? "default" : "ghost"}
                    className={activeHub === "bluenote" ? "bg-blue-500 hover:bg-blue-600 text-lg px-6 py-3" : "text-lg px-6 py-3"}
                    size="lg"
                  >
                    <span className="text-2xl mr-2">🔵</span> Blue Note
                  </Button>
                </div>
              </div>
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-lg text-gray-700">
                  {activeHub === "merle"
                    ...
                    : "Explore the iconic album cover art of Blue Note Records"}
                </p>
              </div>
              ...
              {activeHub === "merle" ? (
                ...
                <div className="grid md:grid-cols-1 gap-6 max-w-md mx-auto">
                  {/* Blue Note Book */}
                  <Link href="/paginated?transcriptId=bluenote">
                    <Card className="h-full hover:shadow-lg transition-all hover:scale-105 cursor-pointer bg-white border-2 border-blue-200 hover:border-blue-400">
                      <CardContent className="p-6 text-center">
                        <img
                          src="/bluenote-cover.png"
                          alt="The Cover Art of Blue Note Records book cover"
              ...
              <div className="mt-6 space-y-2">
                <div className="p-3 bg-gradient-to-r from-blue-100 to-indigo-100 border-2 border-blue-400 rounded-lg">
                  <div className="flex items-center justify-center gap-3">
                    ...
                    <span className="text-blue-700 text-sm">
                      | Commit: <span className="font-semibold">ba5f45a</span>
                    </span>
                  </div>
                </div>
