      ...
      >
        <div className="bg-white rounded-3xl shadow-2xl w-[936px] max-w-[90vw] overflow-hidden border border-gray-100">
          ...
          <div className="relative bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-700 px-8 pt-8 pb-6">
            ...
            {/* Subtitle */}
            <p className="text-white text-[19px] mt-3 leading-relaxed font-medium pl-14">
          ...
          <div className="px-10 py-5">
            ...
            <div className="mb-6">
              <label className="text-base font-bold text-indigo-700 uppercase tracking-wider mb-4 block flex items-center gap-2">
              ...
              <div className="relative group">
                ...
                <blockquote className="relative pl-8 pr-6 py-5 bg-white/80 backdrop-blur-sm rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
                  <div className="text-gray-900 leading-loose font-serif text-[20px] selection:bg-yellow-200 selection:text-gray-900">
            ...
            <div className="mb-6">
              <label className="text-base font-bold text-indigo-700 uppercase tracking-wider mb-4 block flex items-center gap-2">
                ...
                Add Your Context
                <span className="text-indigo-500 font-normal normal-case text-sm ml-2 bg-indigo-100 px-2 py-0.5 rounded-full">optional</span>
              </label>
              <div className="relative">
                <textarea
                  ...
                  className="w-full px-5 py-4 border-2 border-indigo-200 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-400 resize-none transition-all duration-300 text-gray-900 placeholder-indigo-400 text-[32px] font-medium leading-relaxed shadow-sm hover:shadow-md"
                  rows={2}
                  style={{
                    fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif'
                  }}
                />
                <div className="absolute bottom-4 right-4 text-base font-medium text-indigo-600 bg-white px-2 py-1 rounded-lg shadow-sm">
              ...
              <div className="mt-5 space-y-3">
                <p className="text-sm font-semibold text-indigo-600 uppercase tracking-wider">Quick Suggestions</p>
                <div className="flex flex-wrap gap-3">
                  <button
                    onClick={() => setUserContext('Tell me about the cultural significance of this passage')}
                    className="group relative px-6 py-3 text-[16px] font-medium text-gray-700 bg-gradient-to-r from-blue-50 to-indigo-50 hover:from-blue-100 hover:to-indigo-100 rounded-full transition-all duration-300 transform hover:scale-105 hover:shadow-lg border border-blue-200/50 hover:border-blue-300"
                  >
                  ...
                  <button
                    ...
                    className="group relative px-6 py-3 text-[16px] font-medium text-gray-700 bg-gradient-to-r from-purple-50 to-pink-50 hover:from-purple-100 hover:to-pink-100 rounded-full transition-all duration-300 transform hover:scale-105 hover:shadow-lg border border-purple-200/50 hover:border-purple-300"
                  >
                    <span className="relative z-10 flex items-center gap-2">
                      <span className="text-lg">🗽</span>
                      1960s NYC Context
                  ...
                  <button
                    ...
                    className="group relative px-6 py-3 text-[16px] font-medium text-gray-700 bg-gradient-to-r from-green-50 to-emerald-50 hover:from-green-100 hover:to-emerald-100 rounded-full transition-all duration-300 transform hover:scale-105 hover:shadow-lg border border-green-200/50 hover:border-green-300"
                  >
                    <span className="relative z-10 flex items-center gap-2">
                      <span className="text-lg">🎨</span>
                      Related Artists
            ...
            <div className="flex gap-4">
              <button
                ...
                className="group flex-1 relative bg-white text-indigo-600 px-8 py-5 rounded-2xl hover:bg-indigo-50 transition-all duration-300 font-semibold text-[19px] shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center justify-center gap-3 border-2 border-indigo-400 hover:border-indigo-500"
              >
              ...
              <button
                ...
                className="group flex-1 relative bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-600 text-white px-8 py-5 rounded-2xl hover:from-blue-600 hover:via-indigo-600 hover:to-purple-700 transition-all duration-300 font-semibold text-[19px] shadow-xl shadow-indigo-500/30 hover:shadow-2xl hover:shadow-indigo-500/40 transform hover:-translate-y-1 flex items-center justify-center gap-3 overflow-hidden"
              >
              ...
              <button
                onClick={handleClose}
                className="px-6 py-5 bg-indigo-100 hover:bg-indigo-200 rounded-2xl transition-all duration-300 font-semibold text-indigo-700 text-[17px] hover:shadow-lg transform hover:-translate-y-0.5 border-2 border-indigo-200 hover:border-indigo-300"
              >
                Cancel
              </button>
            </div>
          ...
          {/* Footer Stats */}
          <div className="px-10 py-4 bg-gradient-to-r from-indigo-50 to-white border-t border-indigo-200">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-6">
                <span className="flex items-center gap-2 text-base font-medium text-indigo-600">
                  <Hash size={18} className="text-indigo-500" />
                  <span className="font-bold text-indigo-800">{selectedText.split(' ').length}</span> words
                </span>
                <span className="text-indigo-300 text-lg">•</span>
                <span className="text-base font-medium text-indigo-600">
                  <span className="font-bold text-indigo-800">{selectedText.length}</span> characters
                </span>
              </div>
              <span className="text-base text-indigo-600 flex items-center gap-2">
                Press 
                <kbd className="px-3 py-1.5 bg-white border-2 border-indigo-300 rounded-lg text-[14px] font-bold font-mono shadow-sm">
                  ESC
                </kbd>
                to close
              </span>
